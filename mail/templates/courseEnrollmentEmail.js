export const courseEnrollmentEmail = (courseName, name) => {
  return `<!DOCTYPE html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Course Registration Confirmation || Course Craft</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <div class="message">Course Registration Confirmation || Course Craft</div>
            ...
            <div class="support">
                If you need assistance, reach us at 
                <a href="mailto:praveensingh969500@gmail.com">praveensingh969500@gmail.com</a>.
            </div>
        </div>
    </body>
